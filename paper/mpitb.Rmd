...
@af11 proposed a flexible approach to measure multidimensional poverty that can be tailored to different contexts and policy purposes. It mainly distinguishes for its "dual cutoff counting approach" for identification of the poor [for a detailed description, see @alkire2015multidimensional]. Calculating a multidimensional poverty index (MPI) based on this method can be summarized in the following steps:
\begin{enumerate}
