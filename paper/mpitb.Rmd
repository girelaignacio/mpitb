...
Over the last two decades, there has been a substantial increase in the use of multidimensional poverty measures both in academic literature and policy practice.


However, calculating AF measures in practice is still challenging with regard to the lack of a unified and integrated framework on how to produce, analyse and present different estimates. 
